...
public class JsonFacadeTests
{
    ...
    {
        var visitorType = Type.GetType("vm2.Linq.Expressions.Serialization.Json.FromJsonTransformVisitor, Serialization.Json", throwOnError: true)!;
    ...
    [Fact]
    public void ToJsonDocument_And_ToExpression_RoundTrip_LinqCall()
    {
    ...
    [Fact]
    public void ToJsonDocument_And_ToExpression_RoundTrip_GenericArrayCall()
    {
    ...
    [Fact]
    public void ToJsonDocument_And_ToExpression_RoundTrip_GenericListCall()
    {
    ...
    [Fact]
    public void ToJsonDocument_And_ToExpression_RoundTrip_GenericByRefCall()
    {
    ...
    {
        var doc = _linqExpr.ToJsonDocument().AsObject();
        var method = doc["expression"]!["lambda"]!["body"]!["call"]!["arguments"]![0]!["call"]!["method"]!.AsObject();
    ...
    {
        var doc = _genericConstrainedExpr.ToJsonDocument().AsObject();
        var itemsSpec = doc["expression"]!["lambda"]!["body"]!["call"]!["method"]!["parameterSpecs"]![0]!.AsObject();
